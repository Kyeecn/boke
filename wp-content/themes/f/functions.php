...
$foreverwood_themever = "1.1.0";						//Theme version
...
function foreverwood_setup() {
  ...
  $foreverwood_font_url = add_query_arg( 'family', 'PT+Sans', "//fonts.useso.com/css" );
...
function foreverwood_scripts_styles() {
    ...
    wp_enqueue_style( 'foreverwood-google-font-default', '//fonts.useso.com/css?family=PT+Sans&amp;subset=latin,latin-ext' );
